...
aws ecr create-repository --repository-name dea-calendly
...
docker tag calendly:latest 277361137027.dkr.ecr.us-east-1.amazonaws.com/dea-calendly:latest

##you can get above URI from AWS ECR console
## Command to connect to AWS ECR
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 277361137027.dkr.ecr.us-east-1.amazonaws.com
...
docker push 277361137027.dkr.ecr.us-east-1.amazonaws.com/dea-calendly:latest
